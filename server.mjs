  ...
  return createServer(async (req, res) => {
    ...
    try {
      ...
      if (pathname === '/api/checkout/quote') {
        ...
        // Validação de entrada: gross deve ser número finito e não negativo
        if (!Number.isFinite(gross) || gross < 0) throw new Error('INVALID_MONEY');
        // Validação de taxa: deve ser número finito entre 0 e 1
      ...
      // Para rotas estáticas, servir index.html como fallback (SPA)
